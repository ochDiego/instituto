...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(100, 10, utf8_decode("Comprobante de Bajas"), 0, 1, 'C', 0);
      $this->Ln(7);
...
$pdf->Output('Comprobante de las bajas ISFTANGACO.pdf', 'D');//nombreDescarga, Visor(I->visualizar - D->descargar)