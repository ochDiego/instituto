...
<div class="container py-3">
    <h1>Instituto Superior de Formación Técnica Angaco</h1>
    ...
    <section class="row">
        ...
        <div class="col">
            <h2 id="desarrolloSoftware">Tecnicatura Superior en Desarrollo de Software</h2>
            <!-- Slider -->
            ...
            <!-- Slider 2 -->
            <h2 id="energiasRenovables">Tecnicatura Superior en Gestión de Energías Renovables</h2>
